...
@section('page-content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Senarai Check Out Pelawat</h1>
        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Rekod Check Out</h6>
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('checkout.edit', $item->id) }}" class="btn btn-sm btn-info">
                                        Edit
                                    </a>
                                    ...
                                    <div class="modal fade" id="modal-delete-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <form method="POST" action="{{ route('checkout.destroy', $item->id) }}">
                                            @method('DELETE')
                                            @csrf
